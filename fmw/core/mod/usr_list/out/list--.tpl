{block name="content"}
	{if isset( $fields )}
		<form method="post">
			<div class="listMenu">
				<button data-msg="Do you really want to delete?" class="l del imgBtn" value="del" name="submitList" type="submit" title="Delete">
					<button title="{i18n key='delete' def='Delete' plain=1}" type="submit" name="submitList" value="del" class="l delListItem imgBtn" data-msg="Do you really want to delete?"  >
