{block name="content"}
	{if isset( $fields )}
		<form method="post">
			<div class="listMenu">
				<button title="{i18n key='delete' def='Delete' plain=1}" type="submit" data-msg="Do you really want to delete?"  name="submitList" value="del" class="l del delListItem imgBtn">
